...
public class SellActivity extends AppCompatActivity {
    ...
    private void tarjetadeprueba() {
        TapTargetView.showFor(this,                 // `this` is an Activity
                TapTarget.forView(findViewById(R.id.inputPrice), "This is a target", "We have the best targets, believe me")
                        // All options below are optional
                        .outerCircleColor(R.color.colorBlack)      // Specify a color for the outer circle
                        ...
                        .textColor(R.color.colorDarkGrey)            // Specify a color for both the title and description text
                        .textTypeface(Typeface.SANS_SERIF)  // Specify a typeface for the text
                        .dimColor(R.color.colorDarkGrey)            // If set, will dim behind the view with 30% opacity of the given color
